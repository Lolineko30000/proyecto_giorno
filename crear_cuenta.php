...
<head>
    ...
    <link rel="stylesheet" href="Viajes2.css">
</head>
                    ...
                    <div class="search-wrap-1 ftco-animate">
                         ...
                         <form action="#">
                            <div class="form-group p-4">
                               ...
                               <div class="form-field">
                                 ...
                                 <input type="date" class="form-control checkin_date" placeholder="Salida">
                             </div>
                         </div>
                     </div>
</form>
                     ...
                     <form action="#">
                        <div class="form-group p-4">
                           ...
                           <div class="form-field">
                             <div class="icon"><span class="fa fa-calendar"></span></div>
                             <input type="date" class="form-control checkout_date" placeholder="Llegada">
                         </div>
                     </div>
                 </div>
</form>
